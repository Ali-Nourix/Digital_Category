...
* **Still missing: none**, apart from the single photo of the new **Calacatta Viola** project, which is not attached because this data has no Calacatta Viola product (see "Uncertain").
...
| Calacatta Viola | `/_project/calacatta-viola/` | `/projects/calacatta-viola/` | none (no product folder) | 1 |
...
3. **Calacatta Viola** is a new project on both live sites (`/_project/calacatta-viola/`, `/projects/calacatta-viola/`, 1 photo: `https://behkooshan.ir/wp-content/uploads/Calacatta-Viola-1.webp`, WebP 640×1080, 84 KB; the Persian page has the same file). The live site also has a product page `/product/calacatta-viola/`, but this data has no `calacatta-viola` product, so the photo is **not attached**. Adding the product would need its specs from the live product page.
